...
TTseq.human.refseq.major.isoform.exon.first.non.single.coverage.antisense.corrected = sapply(exon.first.non.single.list,function(x){sum(apply(t(t((t(t(human.refseq.major.isoform.exon.coverage.antisense.corrected.TTseq[x,c("control_1.bam","control_2.bam")])/alternative.sequencing.depth[c("control_1.tabular","control_2.tabular")])) 
                                                                                                                                                  - t(alternative.cross.contamination[c("control_1.tabular","control_2.tabular")]*t((t(t(human.refseq.major.isoform.exon.coverage.antisense.corrected.TTseq[x,c("RNAseq_control_1.bam","RNAseq_control_2.bam")])/alternative.sequencing.depth[c("RNAseq_control_1.tabular","RNAseq_control_2.tabular")])))))/(1 - alternative.cross.contamination[c("control_1.tabular","control_2.tabular")])),1,function(x){x[x < 0] = 0;sum(x)}))})
...
TTseq.human.refseq.major.isoform.intron.first.non.single.coverage.antisense.corrected = sapply(intron.first.non.single.list,function(x){sum(apply(t(t((t(t(human.refseq.major.isoform.intron.coverage.antisense.corrected.TTseq[x,c("control_1.bam","control_2.bam")])/alternative.sequencing.depth[c("control_1.tabular","control_2.tabular")])) 
                                                                                                                                                  - t(alternative.cross.contamination[c("control_1.tabular","control_2.tabular")]*t((t(t(human.refseq.major.isoform.intron.coverage.antisense.corrected.TTseq[x,c("RNAseq_control_1.bam","RNAseq_control_2.bam")])/alternative.sequencing.depth[c("RNAseq_control_1.tabular","RNAseq_control_2.tabular")])))))/(1 - alternative.cross.contamination[c("control_1.tabular","control_2.tabular")])),1,function(x){x[x < 0] = 0;sum(x)}))})
